...
PACKAGE_NAME="agent-sandbox-operator"
...
do
    ...
    BUILD_IMAGE=$(echo $RELEASE_IMAGE | sed "s|$RELEASE_REGISTRY|$BUILD_REGISTRY|" | sed "s|agent-sandbox-operator-bundle|agent-sandbox-bundle|")
